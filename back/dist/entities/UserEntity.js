...
const AppointmentEntity_1 = require("./AppointmentEntity"); // Corregido el nombre de la entidad
...
__decorate([
    (0, typeorm_1.OneToMany)(() => AppointmentEntity_1.AppointmentEntity, app => app.user),
